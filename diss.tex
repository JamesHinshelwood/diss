...
{\large
    \begin{tabular}{ll}
        ...
        Line Count:         & \input{|"find /home/james/part2-project/impl/dpl \string\( -name *.rs -o -name *.lalrpop -o -path */examples/* \string\) -not -path */target/* | xargs wc -l | tail -n 1 | head -c 5 | tail -c 4"} \\
...
\section{\texttt{bool}}
\lstinputlisting[breaklines,basicstyle=\ttfamily\scriptsize]{bool}

\section{\texttt{nat}}
\lstinputlisting[breaklines,basicstyle=\ttfamily\scriptsize]{nat}

\section{\texttt{vector}}
\lstinputlisting[breaklines,basicstyle=\ttfamily\scriptsize]{vector}

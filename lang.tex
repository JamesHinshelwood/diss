...
\texttt{>}}}
\newcommand{\sumi}[2]{\ensuremath{\{\texttt{<} #1_i : #2_i \texttt{>}\}^{i \in \range{1}{n}}}}
...
\newcommand{\casei}[6]{\ensuremath{\mathtt{case}\{[#1.#2]\}^?\ #3\ \mathtt{of}\ \{\texttt{<} #4_i = #5_i \texttt{>} \rightarrow #6_i\}^{i \in \range{1}{n}}}}
...
\newcommand{\syntax}[0]{\[
    ...
    & \alt & \casei{x_0}{\tau}{e_0}{l}{x}{e} & case with optional annotation \\
    \rule{0pt}{4ex}
    & \alt & \Unit & unit type \\
    & \alt & \unit & unit \\
...
\newcommand{\rules}[0]{\begin{mathparpagebreakable}
    ...
    \inferrule{\infer{\Gamma}{e_0}{\sumi{l}{\tau}} \\ \check{\Gamma, x : \sumi{l}{\tau}}{\tau}{\type} \\ \forall i \ldotp \check{\Gamma, x_i : \tau_i}{e_i}{[\variant{l_i}{e_i} / x]\tau}} {\infer{\Gamma}{\caseiwithannot{x_0}{\tau}{e_0}{l}{x}{e}}{[e_0 / x] \tau}}
    \\
